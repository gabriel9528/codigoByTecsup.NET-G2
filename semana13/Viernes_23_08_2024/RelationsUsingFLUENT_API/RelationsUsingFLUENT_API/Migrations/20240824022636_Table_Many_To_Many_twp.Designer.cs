...
namespace RelationsUsingFLUENT_API.Migrations
{
    ...
    [Migration("20240824022636_Table_Many_To_Many_twp")]
    partial class Table_Many_To_Many_twp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RelationsUsingFLUENT_API.Models.ManyToMany.Ejercicio2.Business", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RelationsUsingFLUENT_API.Models.ManyToMany.Ejercicio2.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RelationsUsingFLUENT_API.Models.ManyToMany.Ejercicio2.PersonBusiness", b =>
                {
            ...
            modelBuilder.Entity("RelationsUsingFLUENT_API.Models.ManyToMany.Ejercicio2.PersonBusiness", b =>
                {
                    b.HasOne("RelationsUsingFLUENT_API.Models.ManyToMany.Ejercicio2.Business", "Business")
                        .WithMany("PersonBusinesses")
                        .HasForeignKey("BusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RelationsUsingFLUENT_API.Models.ManyToMany.Ejercicio2.Person", "Person")
                        .WithMany("PersonBusiness")
