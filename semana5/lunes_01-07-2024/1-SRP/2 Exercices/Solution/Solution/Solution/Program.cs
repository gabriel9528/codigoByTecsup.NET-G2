...
namespace Solution
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            report.AddEntry(new CourseReportEntry { Name = "Patrones de diseño3", Students = 1000, Rating = 5 });
            report.AddEntry(new CourseReportEntry { Name = "Flutter3", Students = 1900, Rating = 4.5 });

            Console.WriteLine(report.ToString());
            Console.ReadLine();

            var saver = new FileSaver();
            saver.SaveToFile(@"Reports2", "WorkReport2.txt", report);
        }
    } 
    ...
    //Solo se encarga de la persistencia de los datos
